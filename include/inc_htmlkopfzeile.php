...
$user = $_SESSION['user'];
echo "<h1 style='float:right; margin-top:0.7%; margin-right:2%; color: #ff2e2e;' class='userloggedin'>$user</h2>";
echo "<h1 style='float:right; margin-top:0.7%; margin-right:3%' class='userloggedin'>|</h2>";
...
echo "<button style='float:right; margin-top:0.4%; margin-right:0.3%' class='menubutton' onClick=\"window.location.href='nutzerListe.php'\">nutzerliste</button>";
  ...
  echo "<button style='float:left; margin-top:0.4%; margin-left:-1%' class='menubutton' onClick=\"window.location.href='scr_logout.php'\">« zurück</button>";
}
...
echo "<button style='float:right; margin-top:0.5%; margin-right:1%' class='abmeldebutton' onClick=\"window.location.href='scr_logout.php'\">abmelden »</button>";
$user = $_SESSION['user'];
echo "<h1 style='float:right; margin-top:0.7%; margin-right:2%' class='userloggedin'>$user</h2>";
echo "<h1 style='float:right; margin-top:0.7%; margin-right:3%' class='userloggedin'>|</h2>";
